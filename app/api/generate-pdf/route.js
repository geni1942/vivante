...
async function generateItinerarioPdf(itinerario, formData, planLabel) {
  try {
    ...
    if (itinerario.vuelos?.length) {
      ...
      const fHdr = ['Aerol\u00ednea','Ruta / Escala','Precio est.','Duraci\u00f3n','Tip','Ver'].map((t,idx) => ({
